...
M.current_theme_colors = function()
	...
	-- vim.cmd([[
	--  source lua/user/plugins/lualine
	--  ]])
end
...
-- 	end
--
-- 	local color = M.color_palettes.tokyonight
-- 	fg_bg("TelescopeBorder", color.bg_dark, color.bg_dark)
-- 	fg_bg("TelescopePromptBorder", color.terminal_black, color.terminal_black)
-- 	fg_bg("TelescopePromptNormal", color.white, color.terminal_black)
-- 	fg_bg("TelescopePromptPrefix", color.red, color.terminal_black)
-- 	bg("TelescopeNormal", color.bg_dark)
-- 	fg_bg("TelescopePreviewTitle", color.bg, color.green)
-- 	fg_bg("TelescopePromptTitle", color.bg, color.red)
-- 	fg_bg("TelescopeResultsTitle", color.bg_dark, color.bg_dark)
-- 	bg("TelescopeSelection", color.terminal_black)
-- end
